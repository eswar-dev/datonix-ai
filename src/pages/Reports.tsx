...
import { FileText, Download, Share2, Maximize2, ZoomIn, ZoomOut, Plus, Search } from "lucide-react";

const mockReports = [
  { id: "1", name: "Q4 Revenue Analysis", type: "Financial", date: "2026-03-14", author: "Jane Doe" },
  { id: "2", name: "Customer Churn Report", type: "Analytics", date: "2026-03-12", author: "John Smith" },
  { id: "3", name: "Inventory Status", type: "Operations", date: "2026-03-10", author: "Jane Doe" },
  { id: "4", name: "Marketing ROI", type: "Marketing", date: "2026-03-08", author: "Sarah Lee" },
];
      ...
      <Card className="flex flex-1 flex-col rounded-card overflow-hidden">
        ...
        <div className="border-t px-4 py-3">
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            <span>Source: sales_q4_2025.csv</span>
            <span>·</span>
