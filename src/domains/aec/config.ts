...
import ComplianceLayer from "./pages/ComplianceLayer";

export const aecConfig: DomainConfig = {
  id: "aec",
  label: "AEC",
  tagline: "AEC ENTERPRISE OPS",
  ...
  nav: [
    ...
    },
    {
      ...
      icon: CircleDot,
      group: "Resource Planning and Scheduling",
    },
    {
      title: "Add Resource",
      path: "/resources/add",
  ...
  routes: [
    ...
    { path: "/compliance", Component: ComplianceLayer },
