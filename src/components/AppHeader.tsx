...
import { Search, Bell, ChevronRight, X, Lock } from "lucide-react";
    ...
    <>
      ...
      {loginOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45">
          <div className="relative w-[440px] rounded-2xl bg-[#f5f4f2] px-10 pb-7 pt-9">
            {/* Close */}
            <button
            ...
            {/* Headings */}
            <h2 className="text-[28px] font-extrabold text-foreground leading-tight">Start Building.</h2>
            <p className="mb-6 text-[22px] font-bold text-muted-foreground/50">Log in to your account</p>

            {/* Google */}
            <div className="relative mb-2.5">
              <button className="flex w-full items-center justify-center gap-2.5 rounded-xl border-[1.5px] border-[#0099FF] bg-white py-3 text-sm font-semibold text-foreground hover:bg-blue-50/50 transition-colors">
                <GoogleIcon />
            ...
            {/* GitHub */}
            <button className="mb-5 flex w-full items-center justify-center gap-2.5 rounded-xl border-[1.5px] border-border bg-white py-3 text-sm font-semibold text-foreground hover:bg-muted/50 transition-colors">
              <GitHubIcon />
            ...
            {/* Email */}
            <button className="mb-5 w-full rounded-xl bg-foreground py-3 text-sm font-semibold text-background hover:opacity-90 transition-opacity">
              Continue with email
            </button>
